...
public class ExtentReportManager extends BaseClass implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		//try {
//			String imgPath = new BaseClass().captureScreen(result.getName());   // need to make driver as static in baseclass coz we are creating new ase class object here
...
//	}
		...
		try {
	        // Get existing test class object
	...
	public void onFinish(ITestContext testContext) {
		...
		/*  try {
		  ...
		  // If we want to sent report via mail automatically ---
